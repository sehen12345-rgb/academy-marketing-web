  ...
  return (
    <div className="fixed bottom-6 right-5 z-50 flex flex-col gap-3">
      ...
      <motion.a
        ...
        className="group flex items-center justify-center w-14 h-14 rounded-full shadow-lg shadow-black/20 bg-[#FEE500] hover:bg-[#F5DC00] transition-colors"
        aria-label="카카오톡 상담"
      >
        {/* KakaoTalk icon */}
      ...
      <motion.a
        ...
        whileHover={{ scale: 1.08 }}
        className="flex items-center justify-center w-14 h-14 rounded-full bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-300/40 transition-colors"
        aria-label="전화 상담"
      >
