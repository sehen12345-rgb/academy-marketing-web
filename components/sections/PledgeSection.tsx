...
const pledges = [
  ...
  {
    num: "02",
    text: "월 선납으로 청구합니다. 광고비는 실집행 금액 그대로 별도 청구되며, 대행 수수료 15%가 별도 부과됩니다.",
    highlight: false,
  },
  {
    num: "03",
    ...
    <section className="py-20 sm:py-28 bg-[#F4F8FF] relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-[#5C6B7E] text-sm mt-4 max-w-md mx-auto tracking-tight leading-relaxed">
            ...
            <motion.div
              ...
              className={`relative rounded-2xl p-5 flex flex-col gap-3 border transition-all duration-200 hover:-translate-y-1 ${
                pledge.highlight
                  ...
                  : "bg-white border-[#E2E8F0] hover:border-[#C5D5EA] hover:shadow-sm"
              }`}
            >
              <span
                className={`text-3xl font-black leading-none tracking-tighter ${
                  pledge.highlight ? "text-[#E8A020]" : "text-[#0B1F3A]/10"
                }`}
              >
                {pledge.num}
              </span>
              ...
              <p
                className={`text-sm leading-relaxed tracking-tight font-medium ${
                  pledge.highlight ? "text-white/85" : "text-[#4A5568]"
                }`}
              >
                {pledge.text}
              </p>
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="text-right">
              <p className="text-[#0B1F3A] font-black text-sm tracking-tight">에듀플로우</p>
              <p className="text-[#8B9BB4] text-[10px] tracking-tight">대표 정필권</p>
            </div>
          </div>
        </motion.div>
      </div>
