...
/* ── 단품 서비스 ── */
const aLaCarteItems = [
  { name: "홈페이지 제작",      market: "300만원",  price: "200만원",  unit: "(일회성)", tag: "웹" },
  { name: "블로그 포스팅 공장형", market: "7만원",    price: "5만원",    unit: "/건",     tag: "블로그" },
  { name: "블로그 포스팅 프리미엄", market: "15만원", price: "10만원",   unit: "/건",     tag: "블로그" },
  { name: "카페 바이럴",        market: "15만원",   price: "10만원",   unit: "/건",     tag: "바이럴" },
  { name: "네이버 파워링크 광고",market: "별도",     price: "상담 후",  unit: "(광고비 포함)", tag: "광고" },
